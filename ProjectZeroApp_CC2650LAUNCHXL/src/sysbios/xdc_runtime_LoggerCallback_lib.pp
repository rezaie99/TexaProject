# 1 "C:/ti/xdctools_3_31_01_33_core/packages/xdc/runtime/LoggerCallback.c"
...
# 17 "C:/ti/xdctools_3_31_01_33_core/packages/xdc/runtime/LoggerCallback.c"
...
# 19 "C:/ti/xdctools_3_31_01_33_core/packages/xdc/runtime/LoggerCallback.c"
# 1 "C:/ti/xdctools_3_31_01_33_core/packages/xdc/runtime/Types.h"
...
# 20 "C:/ti/xdctools_3_31_01_33_core/packages/xdc/runtime/LoggerCallback.c"
...
# 21 "C:/ti/xdctools_3_31_01_33_core/packages/xdc/runtime/LoggerCallback.c"

# 1 "C:\\ti\\xdctools_3_31_01_33_core\\packages\\xdc\\runtime\\package/internal/LoggerCallback.xdc.h"
...
# 544 "C:/ti/xdctools_3_31_01_33_core/packages/xdc/runtime/LoggerCallback.h"
...
# 16 "C:\\ti\\xdctools_3_31_01_33_core\\packages\\xdc\\runtime\\package/internal/LoggerCallback.xdc.h"

# 23 "C:\\ti\\xdctools_3_31_01_33_core\\packages\\xdc\\runtime\\package/internal/LoggerCallback.xdc.h"
...
# 101 "C:\\ti\\xdctools_3_31_01_33_core\\packages\\xdc\\runtime\\package/internal/LoggerCallback.xdc.h"

 
# 1 "Error_inconsistent_object_size_in_xdc.runtime.LoggerCallback"
...
# 23 "C:/ti/xdctools_3_31_01_33_core/packages/xdc/runtime/LoggerCallback.c"



 
Int xdc_runtime_LoggerCallback_Module_startup__E(Int state) 
{
    Int i;
    ...
    if (!xdc_runtime_Startup_rtsDone__E()) {
        return ((0));
    }
    ...
    for (i = 0; i < xdc_runtime_LoggerCallback_Object__count__C; i++) {
        obj = xdc_runtime_LoggerCallback_Object_get(0, i);
        obj->context = (xdc_runtime_LoggerCallback_createInstFxn__C)(obj->arg);
    }
...
void xdc_runtime_LoggerCallback_Instance_init__E(xdc_runtime_LoggerCallback_Object *obj,
    const xdc_runtime_LoggerCallback_Params *prms)
{
    obj->enabled = 1;
    obj->arg     = prms->arg;
    obj->context = (xdc_runtime_LoggerCallback_createInstFxn__C)(obj->arg);
...
Bool xdc_runtime_LoggerCallback_disable__E(xdc_runtime_LoggerCallback_Object *obj)
{
...
Bool xdc_runtime_LoggerCallback_enable__E(xdc_runtime_LoggerCallback_Object *obj)
{
    Bool prev = obj->enabled;
    obj->enabled = 1;
...
void xdc_runtime_LoggerCallback_write0__E(xdc_runtime_LoggerCallback_Object *obj, xdc_runtime_Types_Event evt,
    xdc_runtime_Types_ModuleId mid)
{
    xdc_runtime_Log_EventRec evrec;
    ...
    evrec.evt = ( (xdc_runtime_Types_Event)(((Bits32) ((xdc_runtime_Log_EventId)((evt) >> 16))) << 16 | ((mid) & 0x0000ffff)));

     
    (xdc_runtime_LoggerCallback_outputFxn__C)(obj->context, &evrec, 0);
}



 
void xdc_runtime_LoggerCallback_write1__E(xdc_runtime_LoggerCallback_Object *obj, xdc_runtime_Types_Event evt,
    xdc_runtime_Types_ModuleId mid, IArg a1)
{
    ...
    (xdc_runtime_LoggerCallback_outputFxn__C)(obj->context, &evrec, 1);
}



 
void xdc_runtime_LoggerCallback_write2__E(xdc_runtime_LoggerCallback_Object *obj, xdc_runtime_Types_Event evt,
    xdc_runtime_Types_ModuleId mid, IArg a1, IArg a2)
{
    xdc_runtime_Log_EventRec evrec;
    ...
    (xdc_runtime_LoggerCallback_outputFxn__C)(obj->context, &evrec, 2);
}



 
void xdc_runtime_LoggerCallback_write4__E(xdc_runtime_LoggerCallback_Object *obj, xdc_runtime_Types_Event evt,
    xdc_runtime_Types_ModuleId mid, IArg a1, IArg a2, IArg a3, IArg a4)
{
    xdc_runtime_Log_EventRec evrec;
    ...
    (xdc_runtime_LoggerCallback_outputFxn__C)(obj->context, &evrec, 4);
}



 
void xdc_runtime_LoggerCallback_write8__E(xdc_runtime_LoggerCallback_Object *obj, xdc_runtime_Types_Event evt,
    xdc_runtime_Types_ModuleId mid, IArg a1, IArg a2, IArg a3, IArg a4, IArg a5, IArg a6,
    IArg a7, IArg a8)
{
    xdc_runtime_Log_EventRec evrec;
    ...
    (xdc_runtime_LoggerCallback_outputFxn__C)(obj->context, &evrec, 8);
}
